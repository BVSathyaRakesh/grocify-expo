  ...
  return (
    <>
      <View className="flex-row gap-2">
        <View className="flex-1 rounded-3xl border border-secondary-foreground bg-card-foreground p-4">
          ...
          <Text className="mt-1 text-3xl font-extrabold text-foreground-dark">{pendingItems}</Text>
        </View>

        <View className="flex-1 rounded-3xl border border-secondary-foreground bg-card-foreground p-4">
          <View className="h-8 w-8 items-center justify-center rounded-xl bg-priority-low-foreground">
            <FontAwesome6 name="check" size={18} color="#fff" />
          </View>
          <Text className="mt-3 text-xs uppercase tracking-[1px] text-muted-foreground">
            Completed
          </Text>
          <Text className="mt-1 text-3xl font-extrabold text-foreground-dark">{completedItems}</Text>
        </View>
        ...
        <View className="flex-1 rounded-3xl border border-secondary-foreground bg-card-foreground p-4">
          ...
          <Text className="mt-1 text-3xl font-extrabold text-foreground-dark">{totalItems}</Text>
        </View>
      </View>

      <View className="rounded-3xl border border-secondary-foreground bg-card-foreground p-4">
        <View className="flex-row items-center justify-between">
          <Text className="text-sm font-semibold text-foreground-dark">Completion rate</Text>
