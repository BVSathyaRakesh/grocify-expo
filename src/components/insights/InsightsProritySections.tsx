  ...
  return (
    <View className="rounded-3xl border border-secondary-foreground bg-card-foreground p-4">
      <View className="flex-row items-center justify-between">
        <Text className="text-sm font-semibold text-foreground-dark">High priority remaining</Text>
        <View
      ...
      <Text className="mt-1 text-3xl font-extrabold text-foreground-dark">{highPriority}</Text>
