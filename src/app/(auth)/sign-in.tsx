...
const SignInScreen = () => {
  ...
  return (
    <SafeAreaView className='flex-1 bg-foreground dark:bg-priority-low-foreground' edges={['top']}>
      {/* decorative elements */}
      ...
      <View className='mt-8 flex-1  rounded-t-[36px] bg-card-foreground px-6 pb-8 pt-6'>
